...
var Shuffler = {
  ...
  assignRightAnswer: function() {
    ...
    if (randomNumber === 0 ){
      ...
      spotOne.children[0].children[0].src = '../images/owlslash250.png';
      setTimeout(function(){
      spotOne.children[0].children[0].src = '../images/slash250.png'
      },1000);
    } else if(randomNumber === 1){
      spotTwo.children[0].setAttribute('id', 'winner');
      spotTwo.children[0].children[0].src = '../images/owlslash250.png'
      setTimeout(function(){
      spotTwo.children[0].children[0].src = '../images/slash250.png'
      },1000);
    } else if(randomNumber === 2){
      spotThree.children[0].setAttribute('id', 'winner');
      spotThree.children[0].children[0].src = '../images/owlslash250.png'
      setTimeout(function(){
      spotThree.children[0].children[0].src = '../images/slash250.png'
      },1000);
    }
  },
...
var Responder = {
  ...
  reveal: function() {
    ...
    winnerReveal.children[0].src = '../images/owlslash250.png';
  },
